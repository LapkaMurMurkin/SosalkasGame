...
//     version 1.14.2
//     from Assets/Scripts/Runtime/Core/InputSystem/ActionMap.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Runtime/Core/InputSystem/ActionMap.inputactions".
/// </summary>
/// <remarks>
...
public partial class @ActionMap: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""MainInput"",
            ""id"": ""a7dbf4ec-838e-46f4-9ae8-5eed8e42ea41"",
            ""actions"": [
                {
                    ""name"": ""LeftClick"",
                    ""type"": ""Button"",
                    ""id"": ""f436b568-8dfc-43e5-9c1c-7448a11be6d0"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""RightClick"",
                    ""type"": ""Button"",
                    ""id"": ""00286be6-1516-479b-8483-de147554a2a6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""MousePosition"",
                    ""type"": ""Value"",
                    ""id"": ""5be9343f-e558-40a7-a49e-69d8167235c9"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f85ea796-e5e5-4594-9652-7836ead8323e"",
                ...
                {
                    ""name"": """",
                    ""id"": ""d44835f6-c95a-44e1-a506-e5ab7ccc06f4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a73ac3c6-c769-44e1-a937-426dc520a14a"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_MainInput_LeftClick = m_MainInput.FindAction("LeftClick", throwIfNotFound: true);
        m_MainInput_RightClick = m_MainInput.FindAction("RightClick", throwIfNotFound: true);
        m_MainInput_MousePosition = m_MainInput.FindAction("MousePosition", throwIfNotFound: true);
    }

    ~@ActionMap()
    {
        UnityEngine.Debug.Assert(!m_MainInput.enabled, "This will cause a leak and performance issues, ActionMap.MainInput.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_MainInput_LeftClick;
    private readonly InputAction m_MainInput_RightClick;
    ...
    public struct MainInputActions
    {
        ...
        /// </summary>
        public MainInputActions(@ActionMap wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "MainInput/LeftClick".
        /// </summary>
        public InputAction @LeftClick => m_Wrapper.m_MainInput_LeftClick;
        /// <summary>
        /// Provides access to the underlying input action "MainInput/RightClick".
        /// </summary>
        public InputAction @RightClick => m_Wrapper.m_MainInput_RightClick;
        /// <summary>
        /// Provides access to the underlying input action "MainInput/MousePosition".
        /// </summary>
